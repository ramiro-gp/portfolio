...
export const copy: Record<LocaleCode, Copy> = {
  es: {
    ...
    desktopCaption: 'Vista desktop de la Home: presentación de Casa San Juan y Casa Boedo.',
    mobileCaption: 'Vista mobile de “Nuestras residencias”, con Casa San Juan y navegación adaptada.',
    desktopAlt: 'Captura real de la Home de Residencias Grupo Casa en desktop: presentación de Casa San Juan y Casa Boedo, próxima apertura.',
    mobileAlt: 'Captura real de la Home de Residencias Grupo Casa en mobile: sección Nuestras residencias, Casa San Juan y navegación compacta.',
  ...
  en: {
    ...
    desktopCaption: 'Desktop view of the home page: Casa San Juan and Casa Boedo are presented.', mobileCaption: 'Mobile view of “Our residences”, showing Casa San Juan and adapted navigation.',
    desktopAlt: 'Real screenshot of the Residencias Grupo Casa home page on desktop: Casa San Juan and Casa Boedo, announced as opening soon.', mobileAlt: 'Real screenshot of the Residencias Grupo Casa home page on mobile: “Our residences”, Casa San Juan and compact navigation.',
    aboutTitle: 'Ramiro Garcia', professionalTitle: 'Full Stack Developer',
  ...
  pt: {
    ...
    desktopCaption: 'Vista da página inicial no computador: apresentação de Casa San Juan e Casa Boedo.', mobileCaption: 'Vista de “Nossas residências” no celular, com Casa San Juan e navegação adaptada.',
    desktopAlt: 'Captura real da página inicial de Residencias Grupo Casa no computador: Casa San Juan e Casa Boedo, anunciada como futura inauguração.', mobileAlt: 'Captura real da página inicial de Residencias Grupo Casa no celular: seção “Nossas residências”, Casa San Juan e navegação compacta.',
    aboutTitle: 'Ramiro Garcia', professionalTitle: 'Full Stack Developer',
  ...
  fr: {
    ...
    desktopCaption: 'Vue de la page d’accueil sur ordinateur : présentation de Casa San Juan et Casa Boedo.', mobileCaption: 'Vue de « Nos résidences » sur mobile, avec Casa San Juan et une navigation adaptée.',
    desktopAlt: 'Capture réelle de la page d’accueil de Residencias Grupo Casa sur ordinateur : présentation de Casa San Juan et Casa Boedo, dont l’ouverture est annoncée prochainement.', mobileAlt: 'Capture réelle de la page d’accueil de Residencias Grupo Casa sur mobile : rubrique « Nos résidences », Casa San Juan et navigation compacte.',
    aboutTitle: 'Ramiro Garcia', professionalTitle: 'Full Stack Developer',
  ...
  ja: {
    ...
    desktopCaption: 'ホームページのデスクトップ表示。Casa San Juan と Casa Boedo を紹介しています。', mobileCaption: 'モバイルの「施設一覧」。Casa San Juan とモバイル向けのナビゲーションを表示しています。',
    desktopAlt: 'Residencias Grupo Casa のホームページをデスクトップで撮影した実際の画面。Casa San Juan と、開設予定の Casa Boedo を紹介しています。', mobileAlt: 'Residencias Grupo Casa のホームページをモバイルで撮影した実際の画面。「施設一覧」、Casa San Juan、コンパクトなナビゲーションが見えます。',
    aboutTitle: 'Ramiro Garcia', professionalTitle: 'Full Stack Developer',
