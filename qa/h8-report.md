...
- Commits de código: `d7850120a72af9f447cdb3fcf28c7bbf26b53cc3` (`Fix black accent path clipping in Ramiro scene`), `78e770dc5d63296dd8b50db9fb4b1bf8a01d0666` (`Align inverse Ramiro node pulse timing`), `e3eb2a2b4caff95ba2a3a295ab8570d43aeb030f` (`Update Services copy before H8 release`) y `1deb12b0c7857fad5fcac360153d184c155abd38` (`Polish localized Services copy`). Push normal exitoso a `origin/main`; `1deb12b` es el commit fuente del paquete vigente.
...
- QA de copy, directamente sobre Vercel y el commit final: **15/15 PASS**, cinco idiomas × 320/390/1440 px; texto exacto comprobado, tres párrafos, sin overflow, sin cruces de la línea con el texto, sin errores de consola ni requests fallidos. Diez capturas (cinco idiomas × 390/1440) están en `qa/h8-services-copy/` y el resultado en `qa/h8-services-copy-results.json`.
- Deployment vigente verificado en [portfolio-rrrramita.vercel.app](https://portfolio-rrrramita.vercel.app/) con el commit `1deb12b`; las cinco rutas respondieron HTTP 200 y sirvieron sus textos actuales. QA Playwright remoto PASS. El alias es de QA: el dominio final `ramita.dev` no se actualizó.
- ZIP anteriores invalidados y retenidos como `.zip.invalidated` / `.sha256.invalidated`: el de `0af5489a63559b18651a7d10360a54a7a9165506` (SHA `9457fd6e65879db2fff210c1f8a8115d18641fef4e58601f40d1426d5fad5e9c`), el intermedio `d7850120a72af9f447cdb3fcf28c7bbf26b53cc3` (SHA `1f849cb445a23493fa1bcf81c6329bb867ccad32c15e07528fd00b5626589134`), el anterior `78e770dc5d63296dd8b50db9fb4b1bf8a01d0666` (SHA `fbd4b0cc5c658649a2cd7c23f96df5b59496b7c908e8723322ee65c025c6cdfc`) y el intermedio `e3eb2a2b4caff95ba2a3a295ab8570d43aeb030f` (SHA `5e42e9ca1e71f9a20f7acf613b49b89e592e6afa19b34c4293a3229f960ea693`).
- Paquete vigente, generado desde la build fresca de `1deb12b`: `release/ramita-h8-1deb12b0c7857fad5fcac360153d184c155abd38.zip`, 25 archivos y 788.730 bytes, con `dist/` en la raíz y el 404 aprobado incluido. SHA-256 del ZIP: `ecf33fe5203bc21453c2f59f1a7d18018135f30d5093a5fa4a395ac790069ddb`.
- Manifiesto vigente: `release/ramita-h8-1deb12b0c7857fad5fcac360153d184c155abd38.sha256`. Verificación: 25 miembros, hash de cada archivo, del ZIP y de `dist/` coincidentes; `404.html` presente, cero fallos. `release/` queda fuera de Git.
