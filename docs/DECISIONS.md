...
## 2026-09-24 — V2-H5: corrección puntual del path Servicios→Proyectos

Ramiro reemplaza sólo la geometría desktop posterior a Rediseños: giro a la derecha hacia el gutter derivado del primer párrafo «Según el alcance…», descenso con aire por su izquierda, giro a la izquierda una vez superado el bloque y bajada por el corredor izquierdo al comenzar Proyectos. No se permite retorno al lado derecho ni horizontal ancho sobre Proyectos. Anclas: último panel real, párrafo de capacidades, sección/corredor izquierdo real de Proyectos. Se mantienen progreso 85/15, milestones, curvas ortogonales suavizadas, reversibilidad y reduced motion. Mobile/tablet, demás tramos de Servicios, Proyectos, Ramiro y Contacto no cambian. QA de cinco idiomas en las tres resoluciones desktop pasó; H5 continúa IN PROGRESS y H6 no se inicia.
