...
Actualización visual H7 aprobada por Ramiro (2026-09-25): sólo en Light + accent negro, mientras la escena Ramiro está visible, la línea continua y GitHub usan el color inverso blanco `#F1F0EC`; fuera de esa escena la línea vuelve al accent negro. El outline de foco de GitHub también usa blanco en esa combinación. Una transición de color breve respeta reduced motion y no cambia el path ni su grosor. Dark y todos los demás accents conservan exactamente el color seleccionado, incluso donde el contraste de GitHub queda por debajo de AA; esos ratios se registran como excepción de QA P2 y siguen visibles en H7/H8.
