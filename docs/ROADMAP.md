...
Estado: IN PROGRESS — 2026-09-26. Hosting final Hostinger y carga manual por Ramiro confirmados. La línea Light + negro se limita espacialmente a Ramiro y el copy final de Servicios quedó actualizado en cinco idiomas. El alias Vercel se verificó visualmente con QA de copy (15 estados: cinco idiomas × 320/390/1440 px) y regresión de la línea (31 estados, resize, scroll reversible, diez pares theme/accent y reduced motion); sin overflow, colisiones ni errores. `pnpm build`, `pnpm check` y el preflight local 404 pasan. Los paquetes anteriores se invalidaron; el paquete válido actual es `release/ramita-h8-e3eb2a2b4caff95ba2a3a295ab8570d43aeb030f.zip`, SHA-256 `5e42e9ca1e71f9a20f7acf613b49b89e592e6afa19b34c4293a3229f960ea693`, con manifiesto verificado y 404 aprobado. La publicación a Hostinger no se realizó por instrucción expresa. Validación HTTP/TLS/SEO/links/smoke y Lighthouse/PageSpeed sobre `ramita.dev` siguen pendientes. No declarar H8 CLOSED ni V2 DONE antes de esas comprobaciones.
